...
namespace DoANCNPM
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            tit = tit.Trim();
            System.Diagnostics.Debug.WriteLine("query: " + qr);
            System.Diagnostics.Debug.WriteLine("title: " + tit);
            XtraReport xtraRP = new XtraReport();
            SqlConnection cnn = new SqlConnection();
            SqlCommand cmd = new SqlCommand();
            String connect = "Data Source=DESKTOP-RAH6IHC\\NHATNGUYEN;Initial Catalog=QLVT_DH;Integrated Security=True";
        ...
        public void InitDetailsBaseXRTable(DevExpress.XtraReports.UI.XtraReport rep, DataSet ds, String tit)
        {
